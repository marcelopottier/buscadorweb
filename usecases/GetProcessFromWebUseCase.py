...
from src.entities.webdriver import CustomWebDriver

class GetProcessFromWebUseCase:
    def __init__(self):
        driver
    ...
    def execute(driver):
        ...
        return Proccess(processoId, processoClasse, processoAssunto, processoForo, processoVara, processoJuiz, processoDistribuicao, processoControle, processoArea, processoValor, arrPartesProcesso, arrDataMovimentacoes, arrDescricaoMovimentacoes)
